...
# No need to remove the mean from the data. Apparently the EOF solver does this automatically.
...
m = Basemap(projection='cyl', llcrnrlat=-44, urcrnrlat=-10, llcrnrlon=112, urcrnrlon=156)
