...
file_list = glob.glob(twentyc_dir+'aus_omega.????.nc')
...
for cyear in range(1961,1991,1):
    ncdata = Dataset(twentyc_dir+'aus_omega.%s.nc'%(cyear))
...
# Output file
outfile = Dataset("summer_omega_1911-2013.nc",'w')
# Dims
...
setattr(omslp,"long_name","Summer Mean Omega Anomaly")
setattr(omslp,"units","Pa")
setattr(omslp,"standard_name","omega")
