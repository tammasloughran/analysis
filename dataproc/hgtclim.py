"""Turns daily 20C reanalysis 500hPa geopotential data into 
summer anomalies.
"""
...
twentyc_dir = '/media/Jupiter/reanalysis/20crv2/hgt/'
#file_list = glob.glob(twentyc_dir+'monthly_prmsl.????.nc')

ncget = MFDataset(twentyc_dir+'nc3_monthly_hgt.????.nc','r')
...
# Output file
outfile = Dataset("summer_hgt_1911-2011.nc",'w')
# Dims
...
omslp = outfile.createVariable("hgt",'f',dimensions=('time','lat','lon'))
setattr(omslp,"long_name","Summer 500 hPa Geopotential height")
setattr(omslp,"units","m")
setattr(omslp,"standard_name","geopotential_height")
