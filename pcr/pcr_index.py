...
def plot_pcscatter(index, pc, slope, intercept, correlation, p, index_name, pc_name, fname):
    ...
    #plt.plot(ninoslice,(slope+error)*ninoslice+intercept,'--',color='k')
    #plt.plot(ninoslice,(slope-error)*ninoslice+intercept,'--',color='k')
...
plot_pcscatter(ninoslice, hwn_pcs[:,0], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWN rPC1', 'nino3.4_HWNrpc1.eps')
slope, intercept, correlation, p, error = linregress(ninoslice,hwn_pcs[:,1])
plot_pcscatter(ninoslice, hwn_pcs[:,1], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWN rPC2', 'nino3.4_HWNrpc2.eps')
slope, intercept, correlation, p, error = linregress(ninoslice,hwn_pcs[:,2])
plot_pcscatter(ninoslice, hwn_pcs[:,2], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWN rPC3', 'nino3.4_HWNrpc3.eps')
slope, intercept, correlation, p, error = linregress(ninoslice,hwn_pcs[:,3])
plot_pcscatter(ninoslice, hwn_pcs[:,3], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWN rPC4', 'nino3.4_HWNrpc4.eps')

slope, intercept, correlation, p, error = linregress(ninoslice,hwd_pcs[:,0])
plot_pcscatter(ninoslice, hwd_pcs[:,0], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWD rPC1', 'nino3.4_HWDrpc1.eps')
slope, intercept, correlation, p, error = linregress(ninoslice,hwd_pcs[:,1])
plot_pcscatter(ninoslice, hwd_pcs[:,1], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWD rPC2', 'nino3.4_HWDrpc2.eps')
slope, intercept, correlation, p, error = linregress(ninoslice,hwd_pcs[:,2])
plot_pcscatter(ninoslice, hwd_pcs[:,2], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWD rPC3', 'nino3.4_HWDrpc3.eps')
slope, intercept, correlation, p, error = linregress(ninoslice,hwd_pcs[:,3])
plot_pcscatter(ninoslice, hwd_pcs[:,3], slope, intercept, correlation, p, 'Nino3.4 index (decC)', 'HWD rPC4', 'nino3.4_HWDrpc4.eps')
