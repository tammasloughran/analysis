...
plt.boxplot(data-273.15, labels=labels, showmeans=True, notch=True, bootstrap=1000, whis='range')
#plt.boxplot(control_temp_ave, showmeans=True, notch=True, bootstrap=1000, whis='range')
#plt.boxplot(pacnino_temp_ave, showmeans=True, notch=True, bootstrap=1000, whis='range')
#plt.boxplot(pacnina_temp_ave, showmeans=True, notch=True, bootstrap=1000, whis='range')
#plt.boxplot(indpiod_temp_ave, showmeans=True, notch=True, bootstrap=1000, whis='range')
#plt.boxplot(indniod_temp_ave, showmeans=True, notch=True, bootstrap=1000, whis='range')
#plt.boxplot(indpac_temp_ave, showmeans=True, notch=True, bootstrap=1000, whis='range')
