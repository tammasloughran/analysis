...
sig[lsm<50] = 1
_,m = plot_ef(data,axes[3][0])
m.drawmeridians([110,130,150,170],labels=[1,0,0,1],dashes=[5,700],fontsize=8)
...
t, sig = stats.ttest_ind(abs_data, cEF, axis=0, equal_var=False)
sig[lsm<50] = 1
_,m = plot_ef(data,axes[2][0])
m.drawmeridians([110,130,150,170],labels=[1,0,0,0],dashes=[5,700],fontsize=8)
m.drawparallels([-10,-20,-30,-40],labels=[1,0,0,0],dashes=[5,700],fontsize=8)
ndays = index.sum()
...
t, sig = stats.ttest_ind(abs_data, cEF, axis=0, equal_var=False)
sig[lsm<50] = 1
_,m = plot_ef(data,axes[3][1])
m.drawmeridians([110,130,150,170],labels=[0,0,0,1],dashes=[5,700],fontsize=8)
